...
class FrenchiseProductController extends Controller
{
    ...
    public function index()
    {
        ...
        $cats = Category::all();
        $prods = Product::whereIn('user_id',$auth)->orderBy('id','desc')->get();
        $sign = Currency::where('is_default','=',1)->first();
        return view('frenchise.product.index',compact('prods','cats','sign')); 
    }
    ...
    {
        $auth = Auth::guard('frenchise')->user()->vendors()->get()->pluck('id');
        $prods = Product::whereIn('user_id',$auth)->where('status','=',0)->get();
        $sign = Currency::where('is_default','=',1)->first();
        return view('frenchise.product.deactive',compact('prods','sign'));
    }
    ...
    public function create()
    {
     	$cats = Category::all();
        $sign = Currency::where('is_default','=',1)->first();
        return view('frenchise.product.create',compact('cats','sign'));
    }
    ...
    public function store(StoreValidationRequest $request)
    {
        ...
        return redirect()->route('frenchise-prod-index');
    }
    ...
    public function edit($id)
    {
        ...
        if($prod->type == 1)
            return view('frenchise.product.digital_edit',compact('cats','prod','size','colrs','tags','metatags','title','details','sign','title1','details1'));
        elseif($prod->type == 2)
            return view('frenchise.product.license_edit',compact('cats','prod','size','colrs','tags','metatags','title','details','sign','title1','details1'));
        else
            return view('frenchise.product.edit',compact('cats','prod','size','colrs','tags','metatags','title','details','sign','title1','details1','mescheck'));
    }
