...
class SubscribePaypalController extends Controller
{
 ...
 public function store(Request $request){
    ...
    $user = Auth::guard('user')->user();
     ...
     $return_url = action('SubscribePaypalController@payreturn');
     $cancel_url = action('SubscribePaypalController@paycancle');
     $notify_url = action('SubscribePaypalController@notify');
...
// Set TCP timeout to 30 seconds
    ...
    if (strcmp($res, "VERIFIED") == 0 || strcasecmp($res, "VERIFIED") == 0) {
        ...
        $subs = VendorSubscription::findOrFail($order->subscription_id);
        $settings = Generalsetting::findOrFail(1);
