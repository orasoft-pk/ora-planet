...
class Jazzcash extends Model
{
   ...
   private $merchant_id; 
    ...
    {
        // Set API key
        $this->merchant_id 	  = "MC15389";
		$this->password 	  = "tu9abdyuh3";
		$this->integrity_salt = "zz3ux933a8";
		$this->currency 	  = "PKR";
		$this->language 	  = "EN";
		$this->post_url 	  = "https://sandbox.jazzcash.com.pk/ApplicationAPI/API/2.0/Purchase/DoMWalletTransaction";
    } 
 ...
 */
	...
	{ 
		...
		//------------------------------------------------------
		// $DateTime 	= new DateTime();date_create()
        ...
        // print_r($form_data['cprice']);  
        // print_r($form_data); exit;
		$temp_amount 	= $form_data['cprice']*100;
