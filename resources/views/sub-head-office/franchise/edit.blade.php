                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="add-product-box">
                                    ...
                                    <div class="row reorder-xs">
                                        <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                            <div class="product-header-title">
                                                <h2>Edit Frenchise <a href="{{ route('sub_head_office_frenchises') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
                                ...
                                <form class="form-horizontal" action="{{route('sub_head_office_frenchise_update',$frenchise->id)}}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
