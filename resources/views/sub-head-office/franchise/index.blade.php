                                                ...
                                                <table id="product-table_wrapper" class="table table-striped table-hover products dt-responsive" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            <td>
                                                                <a href="{{route('sub_head_office_frenchise_dashboard',$frenchise->id)}}" class="btn btn-primary product-btn" target="_blank"><i class="fa fa-eye"></i> View Dashboard </a><br>
                                                            ...
                                                            <td>
                                                                <span class="text-center text-{{$frenchise->status == 1 ? "success" : "danger"}}">
                                                                    {{$frenchise->status == 1 ? "Active" : "Deactive"}}
                                                                </span>
                                                            </td>
                                                            <!-- <td>
                                                                <span class="dropdown">
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{route('sub_head_office_frenchise_details',$frenchise->id)}}" class="btn btn-primary product-btn"><i class="fa fa-eye"></i>View Details </a><br>
                                                                <a href="{{route('sub_head_office_frenchise_edit',$frenchise->id)}}" class="btn btn-info product-btn"><i class="fa fa-edit"></i>Edit </a><br>
