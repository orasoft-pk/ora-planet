                        ...
                        <div class="dashboard-header-area">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <a href="{{route('franchise_orders_by_status',['franchise'=>$fid, 'all'])}}" class="title-stats title-red">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <a href="{{route('franchise_orders_by_status',['franchise'=>$fid, 'pending'])}}" class="title-stats title-cyan">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <a href="{{route('franchise_orders_by_status',['franchise'=>$fid, 'processing'])}}" class="title-stats title-green">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <a href="{{route('franchise_orders_by_status',['franchise'=>$fid, 'completed'])}}" class="title-stats title-orange">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <a href="{{route('sub_head_office_frenchise_customers',['franchise'=>$fid])}}" class="title-stats title-purple">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <a href="{{route('sub_head_office_franchise_vendors_list',['franchise'=>$fid])}}" class="title-stats title-gray">
