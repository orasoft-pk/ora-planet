                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="30%" style="text-align: right;"><a href="javascript:;" data-href="{{route('sub_head_office_vendor_wt_accept',$withdraw->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-success product-btn"><i class="fa fa-send"></i> Accept</a></td>

                                            <td><a href="javascript:;" data-href="{{route('sub_head_office_vendor_wt_reject',$withdraw->id)}}" data-toggle="modal" data-target="#confirm-delete1" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Reject</a></td>
                                            @endif
                                        </tr>
