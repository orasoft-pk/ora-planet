                        ...
                        <div class="dashboard-header-area">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <a href="{{route('sub_head_office_frenchises')}}" class="title-stats title-red">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <a href="{{route('sub_head_office_frenchises_by_status','pending')}}" class="title-stats title-cyan">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <a href="{{route('sub_head_office_frenchises_by_status','approved')}}" class="title-stats title-green">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <a href="{{route('sub_head_office_orders_by_status', 'all')}}" class="title-stats title-dark">
                                        <div class="icon"><i class="fa fa-shopping-cart fa-5x"></i></div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <a href="{{route('sub_head_office_orders_by_status', 'processing')}}" class="title-stats title-red">
                                        <div class="icon"><i class="fa fa-shopping-cart fa-5x"></i></div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <a href="{{route('sub_head_office_orders_by_status', 'completed')}}" class="title-stats title-green">
                                        <div class="icon"><i class="fa fa-shopping-cart fa-5x"></i></div>
