                                              ...
                                              <tr role="row" class="odd">
                                                    ...
                                                    <td>{{$ad->title}}</td>
                                                      ...
                                                      <td>
                                                        ...
                                                        <a href="javascript:;" data-href="{{route('admin-service-delete',$ad->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Remove</a>
                                                      </td>
                                                  </tr>
                                                  @endforeach
                                                  </tbody>
