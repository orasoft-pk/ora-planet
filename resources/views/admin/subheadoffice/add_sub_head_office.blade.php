                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="add-product-box">
                                    ...
                                    <div class="row reorder-xs">
                                        <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                            <div class="product-header-title">
                                                <h2>Sub Head Office<a href="{{ route('admin.sub_head_office_list') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
                                                <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i>
                                                    Admin <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Sub
                                                    Head Office <i class="fa fa-angle-right" style="margin: 0 2px;"></i>
                                                    Add</p>
                                            </div>
                                        </div>
                                ...
                                <form class="form-horizontal" action="{{ route('admin.sub_head_office_create') }}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="v2">Father Name/ Husband Name
                                            *</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select class="form-control" id="prov" required="" name="province">
                                                ...
                                                <option value="{{ $country->admin_name }}">
                                                    {{ $country->admin_name }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="v4">Home Address *<span>(This Field
                                                is Optional)</span></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="v4">Bank Account <span>(This Field is
                                                Optional)</span></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="v3"> Mobile Number *<span>(This Field
                                                is Optional)</span></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="v3"> Percentage *<span>(This
                                                Percentage is Monthly)</span></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="v3"> Percentage *<span>(This
                                                Percentage is Yearly)</span></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="v3"> Percentage *<span>(This
                                                Percentage is Completion)</span></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="v3">Father Name/ Huband Name Of
                                            Vitnes *</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="v3">Vitnes Mobile# *<span>(This
                                                Field is Optional)</span></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group"> <label class="control-label col-sm-4" for="v5">How Many Franchises Assign *</label>
                                        <div class="col-sm-6">
                                            {{-- <select class="form-control"
                                                    required="" name="Franchises">
                                            ...
                                            <div class='main counter_section'>
                                                {{-- <button class='down_count btn btn-info' title='Down'><i class='icon-minus'></i></button> --}}
                                                <a href="javascript:void(0)" class='down_count btn btn_counter minus' title='Down'><i class="fa fa-minus" aria-hidden="true"></i></a>
                                                <input class='counter form-control' type="text" name="assign_franchise" placeholder="value..." value='0' />
                                                {{-- <button class='up_count btn btn_counter' title='Up'><i class='icon-plus'></i></button> --}}
                                                <a href="javascript:void(0)" class='up_count btn btn_counter plus' title='Up'><i class="fa fa-plus" aria-hidden="true"></i></a>
                                    ...
                                    <div class="form-group"> <label class="control-label col-sm-4" for="v5">How Many Shops in Franchise *</label>
                                        <div class="col-sm-6">
                                            {{-- <select class="form-control"--}}
                                            {{-- required="" name="Franchises">--}}
                                            {{-- <option value="">Choose Shops</option>--}}
                                            {{-- <option value="">Shirt & Tie Shop</option>--}}
                                            {{-- <option value="">Chase Up</option>--}}
                                            {{-- <option value="">Zahra Stores</option>--}}
                                            {{-- </select>--}}

                                            <input type="text" class="form-control " name="shop_count" id="v3" placeholder="Shop">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="v3">Franchise Mobile Number
                                            *</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="v6">Message *<span>(This Field is
                                                Optional)</span></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="v6">Detail *<span>(This Field is
                                                Optional)</span></label>
                                        <div class="col-sm-6">
        ...
        if (prov == "") {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var k in data) {
                        $('#city').append('<option value="' + data[k]['city'] + '">' + data[k][
                            'city'
                        ] + '</option>');
                    }
    ...
    $(document).ready(function() {
        $('#total').focusout(function(ev) {
            ...
            $('#yearly').on('mouseup ', function() {
                $(this).val(Math.min(total - $('#monthly').val(), Math.max(total - $('#monthly')
                    .val(), $(this).val())));
            });

            $('#completion').on('mouseup', function() {
                $(this).val(Math.min(total - (parseFloat($('#monthly').val()) + parseFloat($(
                    '#yearly').val())), Math.max(total - (parseFloat($('#monthly')
                    .val()) + parseFloat($('#yearly').val())), $(this).val())));
            });
