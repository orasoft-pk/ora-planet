                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Edit Sub Head Office <a href="{{ route('admin.sub_head_office_list') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
                                                    <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Sub Head Office <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Sub Head Office List <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Edit</p>
                                                </div>
                                            </div>
                                            @include('includes.notification')
                                        </div>
                                    </div>
                                    <form class="form-horizontal" action="{{route('admin.sub_head_office_update',$frenchise->id)}}" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group"> <label class="control-label col-sm-4"
                                                                        for="v5">How Many Franchises Assign *</label>
                                            <div class="col-sm-6">
                                                ...
                                                <div class='main counter_section'>
                                                    ...
                                                    <input class='counter form-control' type="text" name="assign_frenchise" placeholder="value..." value="{{$frenchise->assign_franchise}}" />
                                        ...
                                        <div class="form-group"> <label class="control-label col-sm-4"
                                                                        for="v5">How Many Shops in Franchise *</label>
                                            <div class="col-sm-6">
                                                {{--                                            <select class="form-control"--}}
                                                {{--                                                required="" name="Franchises">--}}
                                                ...
                                                <input type="text" class="form-control " name="shop_count"
                                                       id="v3" placeholder="Shop" value="{{$frenchise->shop_count}}" >
                                        ...
                                        <div class="add-product-footer">
                                            <button name="" type="submit" class="btn add-product_btn">Update</button>
                                        </div>
                                    </form>
