                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-img-create')}}" method="POST" enctype="multipart/form-data">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="name" id="b1" placeholder="Enter Brand Name" value="" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="b1">URL *</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" name="url" id="b1" placeholder="https://www.google.com" value="" type="url">
                                            </div>
                                        </div>
