                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-cat-type_update',$cat->tb_ct_id)}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              ...
                                              <img width="130px" height="90px" id="adminimg" src="{{ $cat->tb_image ? asset('assets/images/'.$cat->tb_image):'http://fulldubai.com/SiteImages/noimage.png'}}" alt="" id="adminimg">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              ...
                                              <img width="130px" height="90px" id="adminimg1" src="{{ $cat->tb_image1 ? asset('assets/images/'.$cat->tb_image1):'http://fulldubai.com/SiteImages/noimage.png'}}" alt="" id="adminimg1">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              ...
                                              <img width="130px" height="90px" id="adminimg2" src="{{ $cat->tb_image2 ? asset('assets/images/'.$cat->tb_image2):'http://fulldubai.com/SiteImages/noimage.png'}}" alt="" id="adminimg2">
