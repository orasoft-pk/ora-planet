...
<div class="container">
 ...
 <form class="form-horizontal" action="{{route('admin-banner-update', $ad->id)}}" method="POST" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        @if($slug=="Shops Banner")
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="t4">Banner URL *</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" name="top4l" value="{{$ad->top4l}}" id="t4" placeholder="https://www.google.com"   type="url">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="t4">Banner URL *</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" name="top5l" value="{{$ad->top5l}}" id="t5" placeholder="https://www.google.com"   type="url">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="edit_current_photo">Banner Image*</label>
                                            <div class="col-sm-6">
                                                <img src="{{ $ad->top5 ? asset('assets/images/'.$ad->top5):'http://fulldubai.com/SiteImages/noimage.png'}}" alt="Photo" id="adminimg4" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="edit_profile_photo">Select Image</label>
