                                  ...
                                  <div class="add-product-box">
                                    ...
                                    <div class="product__header">
                                      ...
                                      <div class="add-product-header products" style="justify-content: unset;">
                                        <label class="control-label" for="about_page_content" style=" padding-top: 10px; padding-left: 10px;"> Faq Page:</label>
                                            <div class="col-sm-3" style="margin-top: 6px;">
                                                        <span class="dropdown">
                                            <button id="Vendor" class="btn btn-{{$ps->f_status == 1 ? 'primary':'danger'}} product-btn dropdown-toggle btn-xs" type="button" data-toggle="dropdown" style="font-size: 14px;">{{$ps->f_status == 1 ? 'Activated':'Deactivated'}}
                                                <span class="caret"></span></button>
                                                        <ul class="dropdown-menu">
                                                            <li><a href="{{route('admin-faq-update',1)}}">Active</a></li>
                                                            <li><a href="{{route('admin-faq-update',0)}}">Deactive</a></li>
                                                        </ul>
                                                        </span>
                                            </div>
                                      </div>
                                      ...
                                      <table id="product-table_wrapper" class="table table-striped table-hover products dt-responsive" cellspacing="0" width="100%">
                                              ...
                                              <tr role="row" class="odd">
                                                      ...
                                                      <td>
                                                        ...
                                                        <a href="javascript:;" data-href="{{route('admin-fq-delete',$faq->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Remove</a>
                                                      </td>
                                                  </tr>
                                              @endforeach
                                                </tbody>
