                                            ...
                                            @foreach($picks as $ad)                                                
                                              <tr role="row" class="odd">
                                                      ...
                                                      <td>
                                                        ...
                                                        <a href="javascript:;" data-href="{{route('admin-pick-delete',$ad->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Remove</a>
                                                      </td>
                                                  </tr>
                                                  @endforeach
                                                  </tbody>
...
<script type="text/javascript">
  ...
  $( document ).ready(function() {
        $(".add-button").append('<div class="col-sm-4 add-product-btn text-right">'+
          ...
          '<i class="fa fa-plus"></i> Add New Pickup Location</a>'+
          '</div>');                                                                       
});
</script>
