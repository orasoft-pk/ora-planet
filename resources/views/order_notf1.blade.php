      @php
        $order_notff = App\Models\UserNotification::where('order_id','!=',null)->get();
                                                            ...
                                                            <div class="profile-notifi-title">
                                                              ...
                                                              @if($order_notff->count() > 0)
                                                               ...
                                                               <div class="single-notifi-text">
                                                                   <h5><a href="{{route('vendor-order-show1',$notf->order_id)}}" style="color: #333;">You Have a new order.</a></h5>
