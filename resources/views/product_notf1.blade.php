      @php
        $product_notff = App\Models\UserNotification::where('product_id','!=',null)->get();
      ...
      @endphp   
                                                            ...
                                                            <div class="single-comments-area">
                                                               ...
                                                               <div class="single-comments-text">
                                                                   <h5><a href="{{route('user-prod-edit',$notf->product->id)}}" style="color: #333;">{{$notf->product->name > 30 ? substr($notf->product->name,0,30) : $notf->product->name}}</a></h5>
