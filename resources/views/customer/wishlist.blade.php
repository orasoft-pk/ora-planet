                                                    ...
                                                    @foreach($wishes as $prod)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="javascript:;" data-href="{{route('customer-wish-delete',$prod->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Remove</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    </tbody>
