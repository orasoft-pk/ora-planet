                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th width="10%">:</th>
                                                                <td width="45%">{{number_format((float)$order->totalQty??0, 2, '.', '')}}</td>
                                                            </tr>
                                                            @php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th width="10%">:</th>
                                                                <td width="45%">{{$order->currency_sign}} {{number_format((float)round($order->pay_amount * $order->currency_value , 2), 2, '.', '') }}</td>
                                                            </tr>
                                                            <tr>
                                    ...
                                    <table id="example" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($product['item']['user_id'] != 0)
                                                        ...
                                                        @if($user->status == 'shipping')
                                                            <a href="{{route('customer-order-status',['slug' => $user->order_number, 'status' => 'completed'])}}"
                                                ...
                                                <td class="text-center"><span style="width: 20px; height: 20px; display: block; border-radius:100%; border: 1px solid {{$product['color']??'#000'}}; background: {{$product['color']}};"></span></td>
                                                <td>{{$order->currency_sign}} {{number_format((float)round($product['shipping_charges']* $order->currency_value, 2), 2, '.', '')}}</td>
...
<div class="modal fade" id="order_completed" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<script type="text/javascript">
    ...
    $('#order_completed').on('show.bs.modal', function(e) {
