                                                    ...
                                                    @endphp
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="javascript:;" data-href="{{route('customer-favorite-delete',$vendor->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Remove</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    </tbody>
