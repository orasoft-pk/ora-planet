                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    ...
                                                    <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Franchise <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Withdraws <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Withdraw Details
                                                </div>
                                            </div>
