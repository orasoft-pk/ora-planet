                        ...
                        <div class="section-padding add-product-1">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        <form class="form-horizontal" action="{{route('frenchise-prod-update2',$prod->id)}}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="profile-filup-description-box margin-bottom-30">
                            ...
                            <div class="qualification4" id="q4">
                              ...
                              @foreach(array_combine($title1,$details1) as $ttl => $dtl)
                              <div class="qualification-area">
                                  <div class="form-group">
                                      <div class="col-xs-12 col-sm-6">
                                        <label> License Key: </label>
                                        <input class="form-control" name="license[]" placeholder="License Key" type="text" value="{{$ttl}}" required="">
                                      </div>
                                      <div class="col-xs-12 col-sm-6">
                                        <label class="control-label"> License Quantity: </label>
                            <input type="number" name="license_qty[]" value="{{$dtl}}"  class="form-control" min="1">
                          ...
                          <br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" name="platform" id="blood_group_display_name" value="{{$prod->platform}}" placeholder="Enter Platform" type="text" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-4" for="blood_group_display_name">Region * <span>(In Any Language)</span></label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" name="region" id="blood_group_display_name" value="{{$prod->region}}" placeholder="Enter Region" type="text" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-4" for="blood_group_display_name">Type * <span>(In Any Language)</span></label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" name="licence_type" id="blood_group_display_name" value="{{$prod->licence_type}}" placeholder="Enter Type" type="text" >
                                                </div>
                                            </div>
