                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-hover">
                                                            ...
                                                            <tfoot>
                                                                ...
                                                                <tr>
                                                                    <td colspan="6">Shipping Cost({{$order->currency_sign}})</td>
                                                                    <td>{{ toFixed(round($order->shipping_cost , 2)) }}</td>
                                                                </tr>
                                                                @endif
                                                                @if($order->tax != 0)
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td colspan="6">Coupon Discount({{$order->currency_sign}})</td>
                                                                    <td>{{toFixed(round($order->coupon_discount, 2))}}</td>
                                                                </tr>
                                                                @endif
                                                                <tr>
                                                                    <td colspan="5"></td>
                                                                    <td>Total</td>
                                                                    <td>{{$order->currency_sign}} {{ toFixed(round($order->pay_amount * $order->currency_value , 2)) }}</td>
                                                                </tr>
                                                            </tfoot>
                                                        </table>
                                                    </div>
