...
@endif
    ...
    @if($lang->rtl == 1)
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <div class="header-middle-right-wrap text-left">
                                ...
                                @else
                                    <a style="cursor: pointer;" class="no-wish" data-toggle="modal" data-target="#loginModal"><span>{{$lang->wishlists}}</span> <img src="{{ asset('assets/images/fav_icon.png') }}" style="height: 26px;"/></a>
                                @endif
                                </li>
                                    <li>
                                        @if(Auth::guard('customer')->check())
                                            <a style="text-transform: uppercase" href="{{route('customer-dashboard')}}">
                                                <img src="{{ asset('assets/images/user_icon.png') }}" style="height: 26px;"/> 
                                            </a>
                                        @else
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="header-middle-right-wrap text-right">
                                ...
                                @endif
                                    ...
                                    <li class="myCart"><a href="javascript:void(0)"> <img src="{{ asset('assets/images/cart_icon.png') }}" style="height: 26px;"/> <span class="cart-quantity">{{ Session::has('cart') ? count(Session::get('cart')->items) : '0' }}</span>
                                        <div class="addToMycart">
                                            <div class="cart">
                                            @if(Session::has('cart'))
                                            @foreach(Session::get('cart')->items as $product)
                                    ...
                                    <li class="myCart1"><a href="javascript:void(0)"> <i class="fa fa-cart-plus"></i></a> <span class="cart-quantity">{{ Session::has('cart') ? count(Session::get('cart')->items) : '0' }}</span>
                                        ...
                                        @if(Auth::guard('customer')->check())
                                            <a style="text-transform: uppercase" href="{{route('customer-dashboard')}}">
                                                <img src="{{ asset('assets/images/user_icon.png') }}" style="height: 26px;"/> <span>{{$lang->fh}}</span>
                                            </a>
                                        @else
                                            <a style="text-transform: uppercase" href="{{route('customer-login')}}">
                                                <img src="{{ asset('assets/images/user_icon.png') }}" style="height: 26px;"/>
    ...
    @endif
        ...
        @if($lang->rtl == 1)
                    ...
                    <!--                <ul>-->
                    <!--                    @foreach($pages as $pg)-->
                    <!--                    <li><a href="{{route('front.pages',$pg->slug)}}">{{strtoupper($pg->title)}}</a></li>-->
                    <!--                    @endforeach-->
                    <!--                </ul>-->
                    <!--            </li>-->
                    <!--            @endif-->
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-5">
                        <div class="header-menu-wrap">
                           <ul>
                                <li><a href="http://127.0.0.1:8000/category/mens-fashion">Men's Fashion</a></li>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-5">
                        ...
                        <h5><i class="fa fa-angle-down"></i> Shop by Category <i class="fa fa-bars"></i></h5>
                            <ul>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="single-footer-wrap information">
                            <h4 class="footer-title text-right">{{$lang->fl}}</h4>
                            <ul>
                                    <li><a href="http://127.0.0.1:8000/term-conditions"><i class="fa fa-angle-double-left"></i> &nbsp; Term & Conditions</a></li>
                                     <li><a href="http://127.0.0.1:8000/privacy-policy"><i class="fa fa-angle-double-left"></i> &nbsp; Privacy Policy</a></li>
                                    <li><a href="http://127.0.0.1:8000/refund-policy"><i class="fa fa-angle-double-left"></i> &nbsp; Refund Policy</a></li>
                                @if($ps->f_status == 1)
                                    <li><a href="{{route('front.faq')}}"><i class="fa fa-angle-double-left"></i> &nbsp;{{$lang->faq}}</a></li>
                                @endif
                                @if($ps->c_status == 1)
