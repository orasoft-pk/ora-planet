...
<style type="text/css">
    ...
    <link rel="stylesheet" href="{{asset('assets/front/css/plugins/font-awesome/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/front/css/fonts/Linearicons/Linearicons/Font/demo-files/demo.css')}}">
    <link rel="stylesheet" href="{{asset('assets/front/css/plugins/bootstrap4/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/front/css/plugins/owl-carousel/assets/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{asset('assets/front/css/plugins/slick/slick/slick.css')}}">
    <link rel="stylesheet" href="{{asset('assets/front/css/plugins/lightGallery-master/dist/css/lightgallery.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/front/css/plugins/jquery-bar-rating/dist/themes/fontawesome-stars.css')}}">
    <link rel="stylesheet" href="{{asset('assets/front/css/plugins/jquery-ui/jquery-ui.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/front/css/plugins/YTPlayer/dist/css/jquery.mb.YTPlayer.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/front/css/plugins/select2/dist/css/select2.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/front/css/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('assets/front/css/css/market-place-1.css')}}">
                  ...
                  <div class="ps-dropdown">
                    ...
                    <ul class="ps-dropdown-menu">
                            ...
                            @foreach($cur_names as $cn)
                             <li style="width: 100%"><a href="{{route('front.curr',$cn->id)}}">
                                {{$cn->name}}</a>
                             </li>                                           
                            @endforeach
                    </ul>
                    ...
                    <ul class="ps-dropdown-menu">
                      ...
                      @php
                                            ...
                                            @foreach($languages as $ln)
                                             <li style="width: 100%"><a href="{{route('front.lang',$ln->id)}}">
                                                {{$ln->language}}</a>
                                             </li>                                           
                                            @endforeach
                    </ul>
        ...
        <div class="header__content">
          <div class="container">
            <div class="header__content-left">
              ...
              </div><a class="ps-logo" href="{{route('front.index')}}"><img src="{{asset('assets/images/'.$gs->logo)}}" alt="Logo"></a>
            </div>
            ...
            <div class="header__content-right">
              <div class="header__actions">
                ...
                <a class="header__extra" href="{{route('user-wishlists')}}"><i class="icon-heart"></i><span><i>{{$lang->wishlists}}</i></span></a>
                @endif
                <div class="ps-cart--mini">
                  <a class="header__extra" href="#"><i class="icon-bag2"></i><span><i>{{ Session::has('cart') ? count(Session::get('cart')->items) : '0' }}</i></span></a>
                  <div class="ps-cart__content">
                    <div class="ps-cart__items">
                      ...
                      <div class="ps-product--cart-mobile">
                        <div class="ps-product__thumbnail"><a href="{{ route('front.product',[$product['item']['id'],$product['item']['name']]) }}"><img src="{{ asset('assets/images/'.$product['item']['photo']) }}" alt=""></a></div>
                        <div class="ps-product__content"><a class="ps-product__remove" onclick="remove({{$product['item']['id']}})"><i class="icon-cross"></i></a><a href="{{ route('front.product',[$product['item']['id'],$product['item']['name']]) }}">{{strlen($product['item']['name']) > 45 ? substr($product['item']['name'],0,45).'...' : $product['item']['name']}}</a>
                          <p><strong>Sold by:</strong>  YOUNG SHOP</p><small>{{$product['qty']}} x 
                            @if($gs->sign == 0)
                    ...
                    <div class="ps-cart__footer">
                      <h3>Sub Total:<strong>
                          @if($gs->sign == 0)     
                          {{$curr->sign}}{{ Session::has('cart') ? round(Session::get('cart')->totalPrice * $curr->value , 2) : '0.00' }}
                          @else
                          {{ Session::has('cart') ? round(Session::get('cart')->totalPrice * $curr->value , 2) : '0.00' }}{{$curr->sign}}
                          @endif
                      </strong></h3>
                      <figure><a class="ps-btn" href="{{route('front.cart')}}">{{$lang->vdn}}</a><a class="ps-btn" href="{{route('front.checkout')}}">{{$lang->gt}}</a></figure>
                    </div>
                  </div>
                </div>
                <div class="ps-block--user-header">
                  ...
                  <div class="ps-block__right">
                      @if(Auth::guard('user')->check())
                    <a href="{{route('user-dashboard')}}">{{$lang->fh}}</a>
                    @else
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <div class="header-middle-right-wrap text-right">
                                ...
                                @endif
                                    ...
                                    <li class="myCart"><a href="javascript:void(0)"> <i class="fa fa-cart-plus"></i></a> 
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="single-footer-wrap">
                            ...
                            @foreach($lblogs as $lblog)
                                <li>
                                    <img class="blogimgs" height="30" width="31" src="{{asset('assets/images/'.$lblog->photo)}}" alt="footer image">
