                                      ...
                                      <table id="product-table_wrapper" class="table table-striped table-hover products dt-responsive" cellspacing="0" width="100%">
                                              <thead>
                                                  <tr>
                                                    ...
                                                    <th style="width: 130px;">highlights</th>
                                            ...
                                            <button class="btn btn-success product-btn dropdown-toggle btn-xs" type="button" data-toggle="dropdown" style="font-size: 14px;">{{($prod->shop_status == 0) ? "Sale Item" :(($prod->shop_status == 1)? "Discount Items":"Offers Of The Day")}}
                                                <span class="caret"></span></button>
                                                        <ul class="dropdown-menu"> 
                                                            <li><a href="{{route('user-prod-high',['id1'=>$prod->id,'id2'=>2])}}">Offers Of The Day</a></li>
                                                            <li><a href="{{route('user-prod-high',['id1'=>$prod->id,'id2'=>1])}}">Discount Items</a></li> 
                                                            <li><a href="{{route('user-prod-high',['id1'=>$prod->id,'id2'=>0])}}">sale Item</a></li>
