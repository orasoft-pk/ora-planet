                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Favorite Sellers By Customer</h2>
                                    ...
                                    <div class="table-responsive">
                                      <table id="product-table_wrapper" class="table table-striped table-hover products dt-responsive" cellspacing="0" width="100%">
                                                    ...
                                                    <tr role="row">
                                                        ...
                                                        <th style="width: 100px;">Customer Address</th>
                                                    ...
                                                    @php
                                                    $seller = App\Models\Customer::findOrFail($vendor->id);
                                                    @endphp
                                                        <tr>
                                                            <td>{{$seller->id}}</td>
                                                            <td>{{$seller->name}}</td>
                                                            ...
                                                            <td>{{$seller->phone}}</td>
                                                            <td>
                                                                {{--  <a target="_blank" href="{{route('front.vendor',str_replace(' ', '-',($seller->name)))}}" class="btn btn-primary product-btn"><i class="fa fa-eye"></i> View Details</a>  --}}
