                    ...
                    <div class="col-sm-12">
                        ...
                        @foreach($convs as $conv)
                          ...
                          <tr class="conv">
                            ...
                            <td>
                              <a href="{{route('user-message-show',$conv->id)}}" class="btn btn-primary product-btn"><i class="fa fa-eye"></i> View Details</a>
                              <a href="javascript:;" data-href="{{route('user-message-delete1',$conv->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Remove</a>
                            </td>
