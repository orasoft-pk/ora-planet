      @php
        $user_notff = App\Models\Notification::where('user_id','!=',null)->orWhere('vendor_id','!=',null)->get();
                                                            ...
                                                            <div class="profile-wishlist-title">
                                                              ...
                                                              <div class="single-wishlist-area">
                                                               ...
                                                               <div class="single-wishlist-text">
                                                                   <h5><a href="{{route('admin-vendor-show',$notf->user_id)}}" style="color: #333;">A New User Has Registered.</a></h5>
